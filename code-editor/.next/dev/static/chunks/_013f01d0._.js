...
function ForceGraph() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "ForceGraph.useLayoutEffect": ()=>{
            if (!containerRef.current) return;
            const observer = new ResizeObserver({
                "ForceGraph.useLayoutEffect": (entries)=>{
            ...
            return ({
                "ForceGraph.useLayoutEffect": ()=>observer.disconnect()
            })["ForceGraph.useLayoutEffect"];
        }
    }["ForceGraph.useLayoutEffect"], []);
    // Create / update simulation when size is known
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ForceGraph.useEffect": ()=>{
            if (!svgRef.current || size.width === 0 || size.height === 0) return;
            const svg = d3.select(svgRef.current);
            svg.selectAll("*").remove(); // clear old content on resize
            svg.attr("viewBox", `0 0 ${size.width} ${size.height}`).attr("preserveAspectRatio", "xMidYMid meet");
            const link = svg.append("g").attr("stroke", "#475569").attr("stroke-opacity", 0.8).selectAll("line").data(links).join("line");
            const node = svg.append("g").attr("stroke", "#0f172a").attr("stroke-width", 1.5).selectAll("circle").data(nodes).join("circle").attr("r", 10).attr("fill", "#22c55e").call(d3.drag().on("start", {
                "ForceGraph.useEffect.node": (event, d)=>{
                    if (!event.active) simulation.alphaTarget(0.3).restart();
                    d.fx = d.x;
                    d.fy = d.y;
                }
            }["ForceGraph.useEffect.node"]).on("drag", {
                "ForceGraph.useEffect.node": (event, d)=>{
                    // event.x / event.y are already in **local** SVG coords
                    d.fx = event.x;
                    d.fy = event.y;
                }
            }["ForceGraph.useEffect.node"]).on("end", {
                "ForceGraph.useEffect.node": (event, d)=>{
                    if (!event.active) simulation.alphaTarget(0);
                    d.fx = null;
                    d.fy = null;
                }
            }["ForceGraph.useEffect.node"]));
            const label = svg.append("g").attr("font-size", 10).attr("fill", "#e5e7eb").selectAll("text").data(nodes).join("text").attr("text-anchor", "middle").attr("dy", -14).text({
                "ForceGraph.useEffect.label": (d)=>d.id
            }["ForceGraph.useEffect.label"]);
            const simulation = d3.forceSimulation(nodes).force("link", d3.forceLink(links).id({
                "ForceGraph.useEffect.simulation": (d)=>d.id
            }["ForceGraph.useEffect.simulation"]).distance(80)).force("charge", d3.forceManyBody().strength(-180)).force("center", d3.forceCenter(size.width / 2, size.height / 2)).on("tick", {
                "ForceGraph.useEffect.simulation": ()=>{
                    link.attr("x1", {
                        "ForceGraph.useEffect.simulation": (d)=>d.source.x
                    }["ForceGraph.useEffect.simulation"]).attr("y1", {
                        "ForceGraph.useEffect.simulation": (d)=>d.source.y
                    }["ForceGraph.useEffect.simulation"]).attr("x2", {
                        "ForceGraph.useEffect.simulation": (d)=>d.target.x
                    }["ForceGraph.useEffect.simulation"]).attr("y2", {
                        "ForceGraph.useEffect.simulation": (d)=>d.target.y
                    }["ForceGraph.useEffect.simulation"]);
                    node.attr("cx", {
                        "ForceGraph.useEffect.simulation": (d)=>d.x
                    }["ForceGraph.useEffect.simulation"]).attr("cy", {
                        "ForceGraph.useEffect.simulation": (d)=>d.y
                    }["ForceGraph.useEffect.simulation"]);
                    label.attr("x", {
                        "ForceGraph.useEffect.simulation": (d)=>d.x
                    }["ForceGraph.useEffect.simulation"]).attr("y", {
                        "ForceGraph.useEffect.simulation": (d)=>d.y
                    }["ForceGraph.useEffect.simulation"]);
                }
            }["ForceGraph.useEffect.simulation"]);
...
_s(ForceGraph, "EhtTXAYIssbneb8Lz6rXul+kq6U=");
_c = ForceGraph;
var _c;
...
function Home() {
    _s();
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Nat");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "hidden lg:flex lg:w-[40%] min-w-0 border-r border-slate-800 overflow-y-auto",
...
_s(Home, "Y/V8jt0fdWcIwT6H5vED2ASnuWQ=");
_c = Home;
var _c;
...
//# sourceMappingURL=_013f01d0._.js.map